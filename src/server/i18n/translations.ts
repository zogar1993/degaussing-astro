...
type Translation = Record<keyof typeof EN_TEXT, string>
...
export const URL_PARTS = (Object.keys(EN_TEXT) as Array<keyof typeof EN_TEXT>)
	.filter(key => key.startsWith("url."))
	.map(key => ({ en: EN_TEXT[key], es: ES_TEXT[key] }))
